...
type CredentialEntry =
  | typeof staticJwtCredential
  | typeof staticSdJwtCredential
...
function buildResolvedPresentation(entries: ReadonlyArray<CredentialEntry>, mutable: MutableVpMetadata) {
...
function buildOuterJwtVp(entries: ReadonlyArray<CredentialEntry>, mutable: MutableVpMetadata) {
  return {
...
function buildOuterSdJwtVp(entries: ReadonlyArray<CredentialEntry>, mutable: MutableVpMetadata) {
  return {
...
function buildOuterDiVp(entries: ReadonlyArray<CredentialEntry>, mutable: MutableVpMetadata) {
  return {
...
const fixture_outerJwt_innerJwtVc = buildFixture(
  'outerJwt_innerJwtVc',
  'jwt',
  'vc-jwt',
  [staticJwtCredential],
...
const fixture_outerSdJwt_innerDiVc = buildFixture(
  'outerSdJwt_innerDiVc',
  'sd-jwt',
  'vc-di',
  [staticDiCredential],
  {
...
const fixture_outerDi_innerJwtVc = buildFixture('outerDi_innerJwtVc', 'di', 'vc-jwt', [staticJwtCredential], {
  ...
  outerEncoded: 'data:application/vp+di,',
})

const fixture_outerDi_innerSdJwtVc = buildFixture(
  'outerDi_innerSdJwtVc',
  'di',
  'vc-sd-jwt',
  [staticSdJwtCredential],
  {
    ...
    outerEncoded: 'data:application/vp+di,',
  }
)
...
const fixture_outerDi_innerDiVc = buildFixture('outerDi_innerDiVc', 'di', 'vc-di', [staticDiCredential], {
  ...
  outerEncoded: 'data:application/vp+di,',
})
...
const fixture_outerDi_innerNestedJwtVp = buildFixture(
  ...
  [nestedJwtVpEntry],
  {
    ...
    outerEncoded: 'data:application/vp+di,',
...
const fixture_outerDi_innerNestedSdJwtVp = buildFixture(
  ...
  [nestedSdJwtVpEntry],
  {
    ...
    outerEncoded: 'data:application/vp+di,',
